...
##### [[Crystal Structures]] 
For ceramics which bonds are predominantly ionic can be though of as electrically charged ions instead of atoms. Metallic ions or [[Cations]](+) are positively charged; non-metallic ions  or [[anions]](-) are negatively charged.
...
it is also possivle for ceramic compounds to have more then one type of cation; for two types of cations.
