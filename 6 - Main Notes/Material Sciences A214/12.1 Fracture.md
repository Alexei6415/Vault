...
* Standardized tests, particularly those by ASTM in the US, measure fracture toughness.
* These tests use specimens with pre-existing cracks, loaded to failure while measuring load and crack displacement.
* Data analysis ensures test criteria are met for metals, ceramics, polymers, and composites.

### Impact Testing Techniques

* Impact tests (Charpy and Izod) evaluate fracture behaviour at high loading rates.
* They use notched specimens struck by a pendulum hammer to measure absorbed impact energy.
* The Charpy V-notch (CVN) test is commonly used.
* These tests are qualitative and mainly for comparison, not direct design use.
* Impact testing is simpler and less expensive than plane strain fracture toughness testing.

### Ductile-to-Brittle Transition

* Impact tests determine if materials show a ductile-to-brittle transition with decreasing temperature.
* This transition involves a sharp drop in impact energy and a change in fracture surface appearance (fibrous/dull for ductile, granular/shiny for brittle).
* A transition temperature is defined based on a specific impact energy or fracture surface appearance.
* Using materials above their transition temperature is crucial to avoid brittle failure (e.g., steel ships in WWII).
* FCC and HCP metals often don't exhibit this transition.
* High-strength steels and titanium alloys remain brittle with low impact energies.
* BCC steels typically show a ductile-to-brittle transition, sensitive to composition and microstructure (grain size, carbon content).
* Ceramics and polymers also have this transition, typically at higher temperatures for ceramics.